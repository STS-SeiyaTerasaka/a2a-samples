...
@click.option(
    "--description",
    default="Generate or modify images using A2A and CrewAI",
...
@click.option(
    "--entrypoint-module",
    default="crewai.agent_engine_app",
...
@click.option(
    "--requirements-file",
    default="crewai/app_utils/.requirements.txt",
    help="Path to requirements.txt file",
)
@click.option(
    "--env-file",
    default=None,
    help="Path to .env file for environment variables (defaults to crewai/.env)",
)
@click.option(
    "--set-env-vars",
    default=None,
